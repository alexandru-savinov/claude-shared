  ...
  outputs =
    ...
    in
    {
      ...
      checks = forAllSystems (
        ...
        in
        {
          module-all-enabled = pkgs.runCommand "module-all-enabled" {
            ...
            activationKeys = lib.concatStringsSep " " (
              lib.attrNames allEnabled.config.home.activation
            );
          ...
          module-disabled = pkgs.runCommand "module-disabled" {
